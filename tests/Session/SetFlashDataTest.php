...
class SetFlashDataTest extends BaseTestCase
{
	public function test_whenSessionNotStarted_thenFatalErrorTriggered()
	{
		...
		$session->setFlashData('foo', 123);
	}

	public function test_whenSessionStarted_thenDataSettable()
	{
		$mCookies = self::createMock(iCookies::class);
		...
		$result = unserialize($_SESSION['flash']['foo']);
