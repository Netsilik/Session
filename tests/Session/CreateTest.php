...
{
	public function test_whenNewSessionStarted_thenSessionDestroyCalledAndNewReturned()
	{
		...
		$result = $session->create(null);

		$callCount = FunctionOverwrites::getCallCount('session_unset');
